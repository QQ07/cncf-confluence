...
def process_and_store():
    ...
    WEATHER_FILE = os.path.join(SCRIPTS_DIR, "weather.json")
    COMMODITIES_FILE = os.path.join(SCRIPTS_DIR, "commodities.json")
    OUTPUT_CSV = os.path.join(SCRIPTS_DIR, "combined_data.csv")
